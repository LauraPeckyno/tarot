  ...
  return (
    <>
      <div className="navbarContainer">
        ...
        <div className="logo"><img src="https://static.vecteezy.com/system/resources/previews/007/057/839/non_2x/magical-tarot-cards-isolated-on-white-background-esoteric-and-occult-items-for-prediction-hand-drawn-illustration-in-doodle-style-perfect-for-cards-decorations-logo-various-designs-vector.jpg" height="100px"/></div>
      </div>
    </>
  )
}
